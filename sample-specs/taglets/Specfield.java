...
/**
 * A Taglet representing @specfield.
 *
 * Here is the command to compile this class:
 *     javac -cp $JAVA_HOME/lib/tools.jar Specfield.java
 *
 * @author Marco Willemart
 * @version 1.1
 * @since 2013-02-25
 */
public class Specfield implements Taglet {

    private static final String NAME = "specfield";
    private static final String HEADER = "Specification Fields:";
